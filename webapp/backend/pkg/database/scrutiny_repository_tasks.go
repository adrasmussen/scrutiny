...
func (sr *scrutinyRepository) EnsureTasks(ctx context.Context, orgID string) error {
	weeklyTaskName := sr.appConfig.GetString("web.influxdb.tasks") + "-weekly-aggr"
	...
	monthlyTaskName := sr.appConfig.GetString("web.influxdb.tasks") + "-monthly-aggr"
	...
	yearlyTaskName := sr.appConfig.GetString("web.influxdb.tasks") + "-yearly-aggr"
